...
void tracker::predict()
{
    ...
    //LOGE("tracker::predict()");

}

void tracker::update(const DETECTIONS &detections)
{
   // LOGE("tracker::update detections.size %d",detections.size());
...
//    #endif
    ...
    //#endif
    //LOGE("res.unmatched_tracks size = %d\n", unmatched_tracks.size());
    ...
    //#endif
    //LOGE("res.unmatched_detections size = %d\n", unmatched_detections.size());
